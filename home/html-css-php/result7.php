	...
	<div id="center">
		<form name="nForm">
			...
			<tr>
				...
				<div class="kokuban-t2"><span class="title-t2">あなたは万能タイプ！</span>あなたはなんでもできる<ruby>万能<rt>ばんのう</rt></ruby>タイプ！これからもその<ruby>状態<rt>じょうたい</rt></ruby>をキープしよう！
					<!--メモの表示・非表示-->
			...
			<script language="javascript" type="text/javascript">
				...
				function s() {
					...
					for (i = 1; i < 11; i++) {
						var num = "t" + i;
						document.getElementById(num).style.fontSize = 75 + '%';
					}
					for (i = 1; i < 51; i++) {
						var num = "select" + i;
						document.getElementById(num).style.fontSize = 75 + '%';
				...
				function m() {
					...
					for (i = 1; i < 11; i++) {
						var num = "t" + i;
						document.getElementById(num).style.fontSize = 100 + '%';
					}
					for (i = 1; i < 51; i++) {
						var num = "select" + i;
						document.getElementById(num).style.fontSize = 100 + '%';
				...
				function l() {
					...
					for (i = 1; i < 11; i++) {
						var num = "t" + i;
						document.getElementById(num).style.fontSize = 150 + '%';
					}
					for (i = 1; i < 51; i++) {
						var num = "select" + i;
						document.getElementById(num).style.fontSize = 150 + '%';
