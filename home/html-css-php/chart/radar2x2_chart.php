...
<body>
	<div id="center">
		...
		<script>
			...
			time2 = "卒業";
			//チャートの作成
			let myRadar = new Chart($("#Chart1"), conf(js_add_sumS, js_add_sumT, Sname, Tname, time1));
			let Radar = new Chart($("#Chart2"), conf(js_leave_sumS, js_leave_sumT, Sname, Tname, time2));
		</script>

		<input type="button" value="表示切替え" onclick=location.assign("rader2x2_chart2.php") class="btn-gradient-3d-simple2" style="margin-right:30px;">
