	...
	<div id="center">
		<form name="nForm">
			...
			<tr>
				...
				<div class="kokuban-t2"><span class="title-t2">あなたはパイロットタイプ！</span>パイロットのようにルールや
					<ruby>時間<rt>じかん</rt></ruby>を<ruby>守<rt>まも</rt></ruby>り、<ruby>正確<rt>せいかく</rt></ruby>で
					<ruby>計画的<rt>けいかくてき</rt></ruby>に<ruby>行動<rt>こうどう</rt></ruby>ができます。<ruby>予定<rt>よてい</rt></ruby>の
					<ruby>変更<rt>へんこう</rt></ruby>にも<ruby>柔軟<rt>じゅうなん</rt></ruby>に<ruby>対応<rt>たいおう</rt></ruby>できます。また、
					<ruby>整理整頓<rt>せいりせいとん</rt></ruby>がうまく、<ruby>忘<rt>わす</rt></ruby>れ<ruby>物<rt>もの</rt></ruby>をすることもありません。それだけでなく、
					<ruby>学校<rt>がっこう</rt></ruby>でもプライベートでも<ruby>落<rt>お</rt></ruby>ち<ruby>着<rt>つ</rt></ruby>ける
					<ruby>場所<rt>ばしょ</rt></ruby>があり、<ruby>上手<rt>じょうず</rt></ruby>にリラックスできます。そんな<ruby>強<rt>つよ</rt></ruby>みを<ruby>活<rt>い</rt></ruby>かして、のびのびと
					<ruby>自分<rt>じぶん</rt></ruby>の<ruby>夢<rt>ゆめ</rt></ruby>を<ruby>追<rt>お</rt></ruby>いかけ、<ruby>飛<rt>と</rt></ruby>び<ruby>立<rt>た</rt></ruby>ちましょう。
					<!--メモの表示・非表示-->
