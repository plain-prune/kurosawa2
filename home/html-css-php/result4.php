	...
	<div id="center">
		<form name="nForm">
			...
			<tr>
				...
				<div class="kokuban-t2"><span class="title-t2">あなたはインストラクタータイプ！</span>スポーツクラブのインストラクターのように
					<ruby>体<rt>からだ</rt></ruby>を<ruby>動<rt>うご</rt></ruby>かすことが<ruby>好<rt>す</rt></ruby>きで、
					<ruby>健康的<rt>けんこうてき</rt></ruby>です。<ruby>体力<rt>たいりょく</rt></ruby>に<ruby>自身<rt>じしん</rt></ruby>があるだけでなく、
					<ruby>手先<rt>てさき</rt></ruby>も<ruby>意外<rt>いがい</rt></ruby>と<ruby>器用<rt>きよう</rt></ruby>で、<ruby>細<rt>こま</rt></ruby>かいところにも
					<ruby>気持<rt>きも</rt></ruby>ちが<ruby>届<rt>とど</rt></ruby>きます。また、てきぱきと<ruby>元気<rt>げんき</rt></ruby>に
					<ruby>行動<rt>こうどう</rt></ruby>できるため、みんなへのあいさつや<ruby>行動<rt>こうどう</rt></ruby>で、<ruby>自分<rt>じぶん</rt></ruby>だけでなく
					<ruby>周<rt>まわ</rt></ruby>りにも<ruby>元気<rt>げんき</rt></ruby>と<ruby>勇気<rt>ゆうき</rt></ruby>を<ruby>与<rt>あた</rt></ruby>えましょう。
					<!--メモの表示・非表示-->
