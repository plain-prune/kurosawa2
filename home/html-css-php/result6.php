	...
	<div id="center">
		<form name="nForm">
			...
			<tr>
				...
				<div class="kokuban-t2"><span class="title-t2">あなたは秘書タイプ！</span><ruby>秘書<rt>ひしょ</rt></ruby>のように<ruby>自分<rt>じぶん</rt></ruby>の<ruby>体<rt>からだ</rt></ruby>や<ruby>心<rt>こころ</rt></ruby>の<ruby>管理<rt>かんり</rt></ruby>が<ruby>上手<rt>じょうず</rt></ruby>です。ときには、<ruby>自分<rt>じぶん</rt></ruby>に<ruby>厳<rt>きび</rt></ruby>しすぎることもあるようです。また、<ruby>天気<rt>てんき</rt></ruby>や<ruby>季節<rt>きせつ</rt></ruby>、<ruby>体調<rt>たいちょう</rt></ruby>に<ruby>合<rt>あ</rt></ruby>わせて、<ruby>自分<rt>じぶん</rt></ruby>をコーディネートすることもできます。<ruby>気持<rt>きも</rt></ruby>ちの<ruby>支<rt>ささ</rt></ruby>えになるものを<ruby>持<rt>も</rt></ruby>ち、ストレスの<ruby>発散<rt>はっさん</rt></ruby>もとても<ruby>上手<rt>じょうず</rt></ruby>です。そんな<ruby>強<rt>つよ</rt></ruby>みを<ruby>活<rt>い</rt></ruby>かして、<ruby>自分自身<rt>じぶんじしん</rt></ruby>だけでなく、みんなを<ruby>支<rt>ささ</rt></ruby>える<ruby>存在<rt>そんざい</rt></ruby>として、<ruby>心<rt>こころ</rt></ruby>のオアシス<ruby>的存在<rt>てきそんざい</rt></ruby>になりましょう。
					<!--メモの表示・非表示-->
