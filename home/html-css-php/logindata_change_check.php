...
<body>
	<div id="center">
		...
		if ($change_user_name == '' || $change_user_pass == '' || $change_user_pass != $change_user_pass2) {
			...
			print '</table>';
			print '<br />';
			print '<form method="post" action="logindata_change_done.php">';
			...
			print '<br />';
			print '<input type="button" onclick=location.assign("logindata_change.php") value="戻る" class="btn-gradient-3d-simple2">';
