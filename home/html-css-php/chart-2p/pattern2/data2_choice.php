...
<form name="data_choice" method="post" action="radar2_chart.php" class="data_slc">
<table align="center">
<?php foreach($data as $key => $date) :?>
    <?php if(is_array($data[$key]) == true) :?>
        <tr>
            <td>
                <input type="radio" id="<?php print$key?>" name="ds2" value="<?php print$jt_data[$key]['jtid']?>">
            </td>
            <td>
